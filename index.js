// const allcounttry = https://restcountries.com/v3.1/all
// const byname = https://restcountries.com/v3.1/name/{name}
...
const renderallcountries = function () {
  for (let i = 0; i < allcountries.length; i++) {
    ...
    main_card.addEventListener("click", () => {
      window.location.href = `http://127.0.0.1:5500/country.html?country=${allcountries[i].cca2}`;
    });
